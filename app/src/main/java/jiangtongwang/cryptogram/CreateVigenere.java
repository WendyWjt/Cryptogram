...
public class CreateVigenere extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_vigenere);
    ...
    public void buttonAdd( View view )
    {
        ...
        if ( !plaintext.equals("") )
        {
            ...
            if ( key.equals("") )
            {
                key = c.getCrypto().getVigenereDefaultKey();
            }
            c.createVigenere(key);
