...
public class CreateCaesar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_caesar);
    ...
    public void buttonAdd( View view )
    {
        ...
        if ( !( shift.equals("") ) )
        {
            shiftKey = Integer.parseInt( shift );
        }
        else
        {
            shiftKey = 0;
        ...
        if ( !plaintext.equals("") )
        {
            ...
            if ( shiftKey != 0 )
            {
                c.createCaesar( shiftKey );
            }
            else
            {
                c.createCaesar_random();
            }
